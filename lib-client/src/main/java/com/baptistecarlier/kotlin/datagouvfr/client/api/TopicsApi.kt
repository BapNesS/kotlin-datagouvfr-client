...
interface TopicsApi: WithApiKey {
     ...
     */
    suspend fun getListTopics(page: Int? = null, pageSize: Int? = null): Flow<TopicPage?>

    /**
     * Create a topic
     * @param payload (required)
     */
    suspend fun postCreateTopic(payload: Topic): Flow<Topic?>

    /**
     * Delete a given topic
     * @param topic The topic ID or slug (required)
     */
    suspend fun deleteTopic(topic: String): Flow<Boolean?>

    /**
     * Get a given topic
     * @param topic The topic ID or slug (required)
     */
    suspend fun getTopic(topic: String): Flow<Topic?>
     ...
     * @param payload (required)
     */
    suspend fun putUpdateTopic(topic: String, payload: Topic): Flow<Topic?>
